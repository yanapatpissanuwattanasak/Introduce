...
function AboutMe() {
  return (
     ...
     <div id='aboutMe' className="row container-fulid">
        <div className='col-6 d-flex flex-row-reverse container-fulid' style={{marginTop:30}} >
              <Image src="https://storage.cloud.google.com/node-bright/bright.png" rounded style={{width:650,marginRight:-25}} />
        </div>
        ...
        <FadeInSection> 
         ...
         <br/><br/><br/>
            ...
            <div className="row text-left">
                    ...
                    <p>Yanpat Pissanuwattanasak</p><br/>
                    </div>
            </div>
            <div className="row text-left">
                    <div className="col-3 ">
            ...
            <div className="row text-left">
                    ...
                    <div className="col " style={{marginTop:3}}>
                    <p>38/20 Village No. 3 &nbsp;&nbsp;&nbsp;&nbsp; Sub-District : Banhkaw</p>
                    
                    <p>District : Muang Chachoengsao </p>
                    <p>Provice : Chachoengsao</p><br/>
                    </div>
            </div>
            <div className="row text-left">
                    <div className="col-3 ">
